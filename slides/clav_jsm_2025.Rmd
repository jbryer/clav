...
pagedown::chrome_print(input = 'clav_jsm_2025.html', timeout = 120)
```
...
```{r cluster-validation, fig.height=4}
...
```{r cluster-validation-bootstrap, fig.height=3}
...
```{r retraining-validation, fig.height=3}
