...
optimal <- clav::optimal_clusters(
	df = daacs[,daacs_cluster_vars], 
	max_k = 6,
...
.font150[There appears to be no agreement on what k should be!]

--

.font150[And this is when I fell down a rabit hole.]
...
```{r profile-plot, fig.height=5.0, fig.width=12.0, out.width='100%'}
